...
const SupplierBusinessData = ({ route }: any) => {
  ...
  const category = supplierData?.categoryType
          ...
          {supplierImage.map((data: any,index:any) => {
            return (
              <Grid.Column computer={4}>
                <Icon name="close" color="grey" size="large" className="imageRemoveIcon" onClick={()=>deleteSupplierImages(index)} />
...
export default SupplierBusinessData;
